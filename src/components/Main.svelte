<script>
    ...
    let benefits = [
        {name: 'Good solving problems', description: 'description'},
        {name: 'I work well in groups and alone', description: 'description'},
    ]
</script>
...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        <div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-18">
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="text-violet-400">Manuel</span> Estevez Palencia<br>
                A Full Stak <span class="poppins text-violet-400">Developer</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My favourite technologies stock includes: JavaScript, frameworks like VUE or Nuxt, <br>
        ...
        <div class="relative shadow-2xl grid place-item center">
            <img
    ...
    <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
        <div class="flex flex-col gap-24 text-center">
            ...
            flex items-center gap-2 -mb-4 sm:-mb-0 -mt-10 hover:border-violet-700 duration-200 z-[10]"
            >
    ...
    <section 
        id="about" 
        class="py-20 pt-10 lg:pt-16 lg:py-32 
        flex flex-col gap-16 sm:gap-20 md:gap-24 relative"
        >
        <div 
        class="flex flex-col gap-2 text-center relative 
        before:absolute before:top-0 before:left-0 
        before:w-2/3 before:h-1.5 before:bg-violet-700
